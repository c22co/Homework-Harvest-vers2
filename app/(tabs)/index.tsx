...
import TaskTimer from '@/components/TaskTimer'; // keep
// ⛔️ remove provider imports from this screen – they’re in _layout.tsx
...
const styles = StyleSheet.create({
  ...
  toggleButton: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 20, borderWidth: 1 },
  toggleOn: { backgroundColor: 'rgba(255,255,255,0.9)', borderColor: 'rgba(0,0,0,0.08)' },
  toggleOff: { backgroundColor: 'rgba(0,0,0,0.7)', borderColor: 'rgba(255,255,255,0.12)' },
...
export default function HomeScreen() {
  ...
  // spawn a pumpkin near the player
  const spawnPumpkin = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Timer LAST so it sits on top and receives touches */}
      <TaskTimer initialTaskName="" />
    </View>
  );
}
